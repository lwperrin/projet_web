...
def AddGenome(request: HttpRequest):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            try:
                fileCds = request.FILES['cds_file']
                filePep = request.FILES['pep_file']
                fileGen = request.FILES['fasta_file']
                ...
                messages.error(request, 'At least one of the file is not well formatted...')
