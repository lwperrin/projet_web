...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("***Creating users from default_users.txt***"))
        call_command('create-users')
        self.stdout.write(self.style.SUCCESS("=================="))
        self.stdout.write(self.style.SUCCESS("The server is initialized and ready to be launched !"))