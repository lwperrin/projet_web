    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignationForAnnotator', to=settings.AUTH_USER_MODEL)),
                ('sequence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bacterial_genome_annotation.sequence')),
                ('validator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignationForValidator', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
