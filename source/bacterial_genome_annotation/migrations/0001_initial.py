    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isAnwser', models.BooleanField(default=False)),
                ('annotation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bacterial_genome_annotation.annotation')),
                ('question', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bacterial_genome_annotation.comment')),
